...
np.save("../masters_large_data/final_testing/range_testing/bits.npy",bits)
...
np.save("../masters_large_data/final_testing/range_testing/pilot_indices.npy",pilot_indices)
...
np.save("../masters_large_data/final_testing/range_testing/pilot_symbols.npy",pilot_symbols)
...
np.save("../masters_large_data/final_testing/range_testing/all_carriers_shifted.npy",all_carriers_shifted)

print()
print("Saving Pilot Indices Shifted")
np.save("../masters_large_data/final_testing/range_testing/pilot_indices_shifted.npy",pilot_indices_shifted)
