...
'''
Below is my offcial code to generate an OFDM like waveform that has 1250 carriers spaced over 14.4MHz of spectrum.
...
fs = subcarrier_spacing * n_subcarriers  # Sampling rate fs => 20MHz
