function Frame = FrameMapping(P2Symbols,DataSymbols,FCSymbol,P2_CPE,Data_CPE,FC_CPE,L1pre,DVBT2,P2,Remod)
...
switch Remod.PilotValue
    ...
    case 2 %Unchanged
        Asp = 1;
        Acp = (1/DVBT2.A_CP)*DVBT2.A_CP2;
        Ap2 = 1;
    case 3 %Custom
        Asp = Remod.CustomPilot;
        Acp = Remod.CustomPilot;
        Ap2 = Remod.CustomPilot;
end
