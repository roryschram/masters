function [HEven, HOdd] = P2FreqDintPermutation(NFFT,P2)
%Description: Give Permutation vector for frequency interleaving
%References: Implementation guidelines
%Inputs: NFFT - FFT Size
%        P2 - P2 Parameters
% Outputs: HEven - Permutation Matrix related to even (indexed) symbols
%          HOdd - Permutation Matrix related to odd (indexed) symbols
CP2 = P2.C_P2; % Data Carriers in P2 Symbol
...
%% Permutation function Generation
