function Demodremod(RefData,SurvData,OutputFile,Guard,CustomPilot,Pilot)
...
% Convert back to single because the processing chain is currently setup to handle singles
Values_remod = single(Values_remod);
SurvData = single(SurvData);
