function Frame_remodulated = Remodulation(PLPValues,FCValues,RemainingP2,L1presymbols,L1postsymbols,P2_CPE,Data_CPE,FC_CPE,P1foffset,P1ioffset,P2foffset,P2ioffset,L1pre,L1post,Start,Remod)
...
%Frame Mapping
Frame = FrameMapping(P2Symbols,DataSymbols,FCSymbol,P2_CPE,Data_CPE,FC_CPE,L1pre,DVBT2,P2,Remod);
%FFT
TimeFrame = DVBT2FFT(Frame,L1pre,DVBT2,P2);
%Guard interval
DVBT2TimeDomain = Guardinsertion(TimeFrame,L1pre,P2,DVBT2.NFFT,Remod);
...
Frame_remodulated = [P1,DVBT2TimeDomain];
end