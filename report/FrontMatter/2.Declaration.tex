...
\par\noindent\makebox[1.7in]{\includegraphics[width=0.3\linewidth]{../Images/signiture.png}}\hfill\makebox[2.8in]{\today}%
\par\noindent\makebox[2.5in]{\hrulefill} \hfill\makebox[2.0in]{\hrulefill}%
\par\noindent\makebox[2.5in][l]{Rory Schram}      \hfill\makebox[2.0in][l]{Date}%
\\
\\
\\
Total Word Count = 20646
