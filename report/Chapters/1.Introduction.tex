...
%\vspace{0.5cm}
% ----------------------------------------------------
This report outlines the design and implementation of a single pulse classification \gls{radar} that uses an \gls{ofdm} 
based signal with a flat top spectra. A literature review of RADAR and OFDM is presented, followed by the literature concerned with 
using OFDM signals in classification RADARs. Next, the design of the surrounding system to transmit and receive data, process 
the data, and analyse the results is presented. Following this, an experimental design is layed out and explained in detail. Next a 
simulation is performed and then the real world testing is performed. The results and comparison of the simulation and real world 
