...
for i in range(1,21):
    ...
    print("Reading in capture "+str(i))
    received_data = read_complex_data_from_dat("../masters_large_data/received_data/multi_receive/raw_captures/receive"+str(i)+".dat")
    ...
    np.save("../masters_large_data/received_data/multi_receive/data_frames/data_frame"+str(i)+".npy",data_frame)
